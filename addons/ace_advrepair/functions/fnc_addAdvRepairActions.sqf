...
if !(EGVAR(common,settingsInitFinished)) exitWith {
    EGVAR(common,runAtSettingsInitialized) pushBack [FUNC(addAdvRepairActions), _this];
};
...
private _selectionsToIgnore = _vehicle call EFUNC(repair,getSelectionsToIgnore);
...

{
    ...
    if (_selection in _wheelHitSelections) then {
        ...
        private _condition = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceWheel"] call DEFUNC(repair,canRepair)};
        private _statement = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceWheel"] call DEFUNC(repair,repair)};
        ...
        private _condition = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveWheel"] call DEFUNC(repair,canRepair)};
        private _statement = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveWheel"] call DEFUNC(repair,repair)};
        private _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 2] call EFUNC(interact_menu,createAction);
        ...
        private _condition = {("vehicle" in GVAR(patchWheelLocation)) && {[_this select 1, _this select 0, _this select 2 select 0, "PatchWheel"] call DEFUNC(repair,canRepair)}};
        private _statement = {[_this select 1, _this select 0, _this select 2 select 0, "PatchWheel"] call DEFUNC(repair,repair)};
        ...
        if (_hitpoint in FUELTANK_HITPOINTS) exitWith {
            if (_vehfueltanksize == 0) then {
                ...
                private _condition = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveFueltanksmall"] call DEFUNC(repair,canRepair)};
                private _statement = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveFueltanksmall"] call DEFUNC(repair,repair)};
                private _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 3, nil, FUNC(modifySelectionInteraction)] call EFUNC(interact_menu,createAction);
                [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);

                // An action to replace the wheel is required
                _name = format ["Replace_%1_%2", _forEachIndex, _hitpoint];
                _text = localize LSTRING(ReplaceFueltanksmall);
                _condition = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceFueltanksmall"] call DEFUNC(repair,canRepair)};
                _statement = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceFueltanksmall"] call DEFUNC(repair,repair)};
                _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 3] call EFUNC(interact_menu,createAction);
                [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);
                ...
                private _condition = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveFueltanklarge"] call DEFUNC(repair,canRepair)};
                private _statement = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveFueltanklarge"] call DEFUNC(repair,repair)};
                private _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 3, nil, FUNC(modifySelectionInteraction)] call EFUNC(interact_menu,createAction);
                [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);
                ...
                _condition = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceFueltanklarge"] call DEFUNC(repair,canRepair)};
                _statement = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceFueltanklarge"] call DEFUNC(repair,repair)};
                _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 3] call EFUNC(interact_menu,createAction);
                [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);
		...
		if (_hitpoint in GUN_HITPOINTS) exitWith {
            ...
            private _condition = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveGunFCS"] call DEFUNC(repair,canRepair)};
            private _statement = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveGunFCS"] call DEFUNC(repair,repair)};
            private _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 3, nil, FUNC(modifySelectionInteraction)] call EFUNC(interact_menu,createAction);
            [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);
            ...
            _condition = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceGunFCS"] call DEFUNC(repair,canRepair)};
            _statement = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceGunFCS"] call DEFUNC(repair,repair)};
            _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 3] call EFUNC(interact_menu,createAction);
            [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);
		...
		if (_hitpoint in TURRET_HITPOINTS) exitWith {
            ...
            private _condition = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveTurretdrive"] call DEFUNC(repair,canRepair)};
            private _statement = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveTurretdrive"] call DEFUNC(repair,repair)};
            private _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 3, nil, FUNC(modifySelectionInteraction)] call EFUNC(interact_menu,createAction);
            [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);
            ...
            _condition = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceTurretdrive"] call DEFUNC(repair,canRepair)};
            _statement = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceTurretdrive"] call DEFUNC(repair,repair)};
            _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 3] call EFUNC(interact_menu,createAction);
            [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);
        ...
        if (_vehicle isKindOf "Helicopter") exitWith {
		    if (_hitpoint in ROTOR_HITPOINTS) exitWith {
                ...
                private _condition = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveRotorAssembly"] call DEFUNC(repair,canRepair)};
                private _statement = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveRotorAssembly"] call DEFUNC(repair,repair)};
                private _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 8, nil, FUNC(modifySelectionInteraction)] call EFUNC(interact_menu,createAction);
                [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);

                // An action to replace the wheel is required
                _name = format ["Replace_%1_%2", _forEachIndex, _hitpoint];
                _text = localize LSTRING(ReplaceRotorAssembly);
                _condition = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceRotorAssembly"] call DEFUNC(repair,canRepair)};
                _statement = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceRotorAssembly"] call DEFUNC(repair,repair)};
                _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 8] call EFUNC(interact_menu,createAction);
                [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);
		    ...
		    if (_hitpoint == "hitavionics") exitWith {
                ...
                private _condition = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveAvionics"] call DEFUNC(repair,canRepair)};
                private _statement = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveAvionics"] call DEFUNC(repair,repair)};
                private _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 3, nil, FUNC(modifySelectionInteraction)] call EFUNC(interact_menu,createAction);
                [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);
                ...
                _condition = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceAvionics"] call DEFUNC(repair,canRepair)};
                _statement = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceAvionics"] call DEFUNC(repair,repair)};
                _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 3] call EFUNC(interact_menu,createAction);
                [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);
            ...
            if (_hitpoint in HELIENGINE_HITPOINTS) exitWith { 
                ...
                switch (_engineselect) do {
                    default {
                        ...
                        private _condition = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveEnginepistonmedium"] call DEFUNC(repair,canRepair)};
                        private _statement = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveEnginepistonmedium"] call DEFUNC(repair,repair)};
                        private _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 3, nil, FUNC(modifySelectionInteraction)] call EFUNC(interact_menu,createAction);
                        [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);
                        ...
                        _condition = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceEnginepistonmedium"] call DEFUNC(repair,canRepair)};
                        _statement = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceEnginepistonmedium"] call DEFUNC(repair,repair)};
                        _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 3] call EFUNC(interact_menu,createAction);
                        [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);
                    ...
                    case "0piston": {
                        ...
                        private _condition = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveEnginepistonsmall"] call DEFUNC(repair,canRepair)};
                        private _statement = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveEnginepistonsmall"] call DEFUNC(repair,repair)};
                        private _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 3, nil, FUNC(modifySelectionInteraction)] call EFUNC(interact_menu,createAction);
                        [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);
                        ...
                        _condition = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceEnginepistonsmall"] call DEFUNC(repair,canRepair)};
                        _statement = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceEnginepistonsmall"] call DEFUNC(repair,repair)};
                        _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 3] call EFUNC(interact_menu,createAction);
                        [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);
                    ...
                    case "2piston": {
                        ...
                        private _condition = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveEnginepistonlarge"] call DEFUNC(repair,canRepair)};
                        private _statement = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveEnginepistonlarge"] call DEFUNC(repair,repair)};
                        private _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 3, nil, FUNC(modifySelectionInteraction)] call EFUNC(interact_menu,createAction);
                        [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);
                        ...
                        _condition = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceEnginepistonlarge"] call DEFUNC(repair,canRepair)};
                        _statement = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceEnginepistonlarge"] call DEFUNC(repair,repair)};
                        _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 3] call EFUNC(interact_menu,createAction);
                        [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);
                    ...
                    case "1turbine":{
                        ...
                        private _condition = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveEngineturbinesmall"] call DEFUNC(repair,canRepair)};
                        private _statement = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveEngineturbinesmall"] call DEFUNC(repair,repair)};
                        private _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 3, nil, FUNC(modifySelectionInteraction)] call EFUNC(interact_menu,createAction);
                        [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);
                        ...
                        _condition = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceEngineturbinesmall"] call DEFUNC(repair,canRepair)};
                        _statement = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceEngineturbinesmall"] call DEFUNC(repair,repair)};
                        _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 3] call EFUNC(interact_menu,createAction);
                        [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);
                    ...
                    case "2turbine":{
                        ...
                        private _condition = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveEngineturbinelarge"] call DEFUNC(repair,canRepair)};
                        private _statement = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveEngineturbinelarge"] call DEFUNC(repair,repair)};
                        private _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 3, nil, FUNC(modifySelectionInteraction)] call EFUNC(interact_menu,createAction);
                        [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);
                        ...
                        _condition = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceEngineturbinelarge"] call DEFUNC(repair,canRepair)};
                        _statement = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceEngineturbinelarge"] call DEFUNC(repair,repair)};
                        _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 3] call EFUNC(interact_menu,createAction);
                        [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);
        ...
        if (_vehicle isKindOf "Plane") exitWith {
            ...
            if (_hitpoint in CONTROLSURFACES_HITPOINTS) exitWith {
                ...
                private _condition = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveControlsurfaces"] call DEFUNC(repair,canRepair)};
                private _statement = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveControlsurfaces"] call DEFUNC(repair,repair)};
                private _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 3, nil, FUNC(modifySelectionInteraction)] call EFUNC(interact_menu,createAction);
                [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);
                ...
                _condition = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceControlsurfaces"] call DEFUNC(repair,canRepair)};
                _statement = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceControlsurfaces"] call DEFUNC(repair,repair)};
                _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 3] call EFUNC(interact_menu,createAction);
                [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);
        ...
        if (_hitpoint in TRACK_HITPOINTS) exitWith {
            ...
            private _name = format ["Replace_%1_%2", _forEachIndex, _hitpoint];
            private _text = localize LSTRING(ReplaceTrack);
            private _condition = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceTrack"] call DEFUNC(repair,canRepair)};
            private _statement = {[_this select 1, _this select 0, _this select 2 select 0, "ReplaceTrack"] call DEFUNC(repair,repair)};
            private _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 2] call EFUNC(interact_menu,createAction);
            [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);

            // Create a Track interaction
            private _root = format ["Track_%1_%2", _forEachIndex, _hitpoint];
            private _action = [_root, localize LSTRING(Track), ["","#FFFFFF"], {}, {true}, {}, [_hitpoint], _position, 2, nil, LINKFUNC(modifySelectionInteraction)] call EFUNC(interact_menu,createAction);
            [_type, 0, [], _action] call EFUNC(interact_menu,addActionToClass);

            // An action to remove the Track is required
            private _name = format ["Remove_%1_%2", _forEachIndex, _hitpoint];
            private _text = localize LSTRING(RemoveTrack);
            private _condition = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveTrack"] call DEFUNC(repair,canRepair)};
            private _statement = {[_this select 1, _this select 0, _this select 2 select 0, "RemoveTrack"] call DEFUNC(repair,repair)};
            private _action = [_name, _text, _icon, _statement, _condition, {}, [_hitpoint], _position, 2] call EFUNC(interact_menu,createAction);
            [_type, 0, [_root], _action] call EFUNC(interact_menu,addActionToClass);
            ...
            private _condition = {[_this select 1, _this select 0, _this select 2 select 0, "MiscRepair"] call DEFUNC(repair,canRepair)};
            private _statement = {[_this select 1, _this select 0, _this select 2 select 0, "MiscRepair"] call DEFUNC(repair,repair)};
...
private _condition = {[_this select 1, _this select 0, "", "OpenRepairGUI"] call DEFUNC(repair,canRepair)};
private _statement = {[_this select 1, _this select 0, "", "OpenRepairGUI"] call DEFUNC(repair,repair)};
private _action = ["OpenRepairGUI", _text, _icon, _statement, _condition, {}, [], "", 4] call EFUNC(interact_menu,createAction);
