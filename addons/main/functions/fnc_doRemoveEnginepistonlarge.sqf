...
// spawn wheel
private _newobj = ["FL_parts_enginepistonlarge", getPosASL _unit, _hitPointDamage] call ace_repair_fnc_spawnObject;
...
if (ACEVAR(repair,DisplayTextOnRepair)) then {
    [localize LSTRING(RemovedEnginepistonlarge)] call ace_common_fnc_displayTextStructured;
};
